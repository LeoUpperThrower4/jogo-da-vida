      ...
      <div className="mb-2 border-t-2 border-gray-200 px-4 pt-4 sm:mb-0">
        ...
        >
          <input
            ...
            className="w-full rounded-lg bg-gray-200 py-3 px-1 text-gray-600 placeholder-gray-600 focus:placeholder-gray-400 focus:outline-none"
            onChange={(e) => {
          ...
          <div className="absolute inset-y-0 right-0 hidden items-center sm:flex">
            <button
              type="submit"
              className="inline-flex items-center justify-center rounded-r-lg bg-blue-500 px-4 py-3 font-bold text-white transition duration-500 ease-in-out hover:bg-blue-400 focus:outline-none"
            >
              Enviar
            </button>
          </div>
